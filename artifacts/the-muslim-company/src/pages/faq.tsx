...
const FAQ_GROUPS: { title: string; items: FaqItemData[] }[] = [
  {
    ...
    items: [
      ...
      { q: "Who is on The Muslim Company's Board of Directors?", a: "The Board of Directors, along with the company's investors and strategic partners, is listed on our Leadership page — including Founder & CEO Shariful Islam and Independent Director Edward Henry Philips.", links: [{ text: "Leadership page", href: "/leadership" }] },
