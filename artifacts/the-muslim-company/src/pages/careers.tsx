...
export default function Careers() {
  useEffect(() => {
    ...
    if (_ogt_d) _ogt_d.setAttribute('content', "Explore career opportunities at The Muslim Company — a faith-driven global conglomerate committed to ethical innovation, humanitarian development, and civilizational leadership. Join our team in Dhaka, Bangladesh.");
