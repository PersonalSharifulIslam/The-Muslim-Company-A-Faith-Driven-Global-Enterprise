...
import { Search, X, ExternalLink, Send, Clock, Calendar, CheckSquare, Square, MessageSquare, Trash2, Download } from "lucide-react";
              ...
              {messageSentCount !== null ? (
                ...
                <>
                  ...
                  <div>
                    ...
                    />
                    <p className="font-sans text-xs text-gray-600 mt-1">Sent using The Muslim Company's official branded email template.</p>
                  </div>
                  <div className="flex gap-3 pt-2">
