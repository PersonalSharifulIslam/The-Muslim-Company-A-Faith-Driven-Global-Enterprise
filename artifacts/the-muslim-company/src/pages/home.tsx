...
const SECTION_SEO: Record<string, { title: string; description: string; path: string }> = {
  "/our-story": {
    ...
    description: "The story of how The Muslim Company began — from Shariful Islam's observation of ethical drift in modern business to his vision for a Prophetic Model enterprise, founded in Dhaka, Bangladesh in January 2025 and built to grow into a civilization-scale, faith-driven global conglomerate.",
    path: "/our-story",
  },
  "/foundation": {
    title: "Islamic Foundation — The Muslim Company",
    description: "The Islamic foundation behind The Muslim Company — how the Quran, authentic Hadith, Ijma, and Qiyas guide every business decision, and how the company structures itself to remain completely free from riba (interest), bribery, and exploitative practices at every level of operation.",
    path: "/foundation",
  },
  "/sectors": {
    title: "Areas of Work & Sectors — The Muslim Company",
    description: "The Muslim Company operates across 20+ Shariah-compliant business sectors — including Agriculture & Food, Technology & AI, Healthcare, Renewable Energy, Manufacturing, Islamic Finance & FinTech, Media, Education, and Humanitarian & Social Welfare — each governed by the same ethical and religious standards.",
    path: "/sectors",
  },
  "/governance": {
    title: "Governance Structure — The Muslim Company",
    description: "How The Muslim Company is governed — an Independent Supreme Shariah Board with real authority, Amanah-based (trust-centered) leadership, and Shura (consultative) decision-making overseeing every major product, investment, and partnership before it moves forward.",
    path: "/governance",
  },
  "/constitution": {
    title: "Constitutional Framework — The Muslim Company",
    description: "The permanent constitutional framework that protects The Muslim Company's ethical mission — structural safeguards against corruption, hostile takeover, and mission drift, ensuring every future leader remains bound by the same Islamic principles the company was founded on.",
    path: "/constitution",
  },
  "/our-people": {
    title: "Our People — The Muslim Company",
    description: "How The Muslim Company treats its people — fair wages, dignified workplaces with separate facilities for women, extended maternity leave of 1 to 1.5 years, long-term pension qualification, and family welfare programs built into how the company operates.",
    path: "/our-people",
  },
  "/environment": {
    title: "Environmental Stewardship — The Muslim Company",
    description: "The Muslim Company's environmental commitments as stewards of Allah's creation — investment in renewable energy, protection of wildlife and animals, reforestation and tree planting, and ecological restoration woven into operations across every sector.",
    path: "/environment",
  },
  "/humanitarian": {
    title: "Humanitarian Development — The Muslim Company",
    description: "The Muslim Company's humanitarian development work — 10% of monthly net profit funds disaster relief, orphan and widow support, education access, and healthcare programs for vulnerable communities in Bangladesh and beyond, alongside full annual zakat distribution.",
    path: "/humanitarian",
  },
  "/technology": {
    title: "Technology & AI Ethics — The Muslim Company",
    description: "The Muslim Company's ethical framework for technology and artificial intelligence — a firm rejection of harmful AI applications, addiction-engineered systems, privacy-abusive data practices, and mass misinformation tools, in favor of technology that genuinely serves humanity.",
    path: "/technology",
  },
};
