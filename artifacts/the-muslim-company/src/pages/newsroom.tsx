...
export default function Newsroom() {
  ...
  useEffect(() => {
    ...
    supabase.from("newsroom_posts").select("*").eq("published", true).order("created_at", { ascending: false }).then(({ data }) => {
        ...
        <div className="container mx-auto max-w-5xl">
          {!isSupabaseConfigured ? (
            <div className="text-center py-20">
              ...
              <p className="font-sans text-sm text-primary/50 max-w-md mx-auto">Connect Supabase to manage and display news content.</p>
            </div>
          ) : loading ? (
