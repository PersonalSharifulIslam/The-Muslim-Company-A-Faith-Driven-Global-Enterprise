...
export default function RecruitmentStatus() {
  useEffect(() => {
    ...
    const DESC = "Check your job application status at The Muslim Company in real time using your recruitment reference number — fast, secure, no login required.";
    const _md = document.querySelector('meta[name="description"]');
    if (_md) _md.setAttribute('content', DESC);
    const _ogt_d = document.querySelector('meta[property="og:description"]');
    if (_ogt_d) _ogt_d.setAttribute('content', DESC);
